CLASS zcl_abap_file_upload_ap DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_ABAP_FILE_UPLOAD_AP IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.
    CASE request->get_method( ).
      WHEN CONV string( if_web_http_client=>get ).
        DATA(sap_table_request) = request->get_header_field( 'sap-tablerequest' ).
...
METHOD get_html.
 ...
 | data-sap-ui-theme="sap_fiori_3_dark" data-sap-ui-xxbindingSyntax="complex" data-sap-ui-compatVersion="edge" \n| &&
