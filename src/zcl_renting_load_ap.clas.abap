CLASS zcl_renting_load_ap DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RENTING_LOAD_AP IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
  DATA: lt_brands TYPE TABLE OF zrent_brands_ap,
 lt_cars TYPE TABLE OF zrent_cars_ap,
 lt_customers TYPE TABLE OF zrent_custome_ap.
** BRANDS **
 lt_brands = VALUE #(
 ...
 ( marca = 'SEAT' url ='https://www.seat.mx/content/countries/mx/seatwebsite/es/modelos/ibiza/_jcr_content.resizedViewPort.noscale.rangeMiniature.png')
  ...
  ( marca = 'BMW' url =
'https://www.bmw.com.mx/content/dam/bmw/common/allmodels/3-series/sedan/2018/navigation/bmw-3-seriesmodellfinder.png') ).
 DELETE FROM zrent_brands.
 INSERT zrent_brands_ap FROM TABLE @lt_brands.
 SELECT * FROM zrent_brands_ap INTO TABLE
@lt_brands.
 out->write( sy-dbcnt ).
...
'20210701' alq_hasta = '20210708' )
 ( matricula = '2392JFH' marca = 'JEEP' modelo = 'GRAND CHEROKEE' color = 'BLANCO' motor =
...
'20211106' alq_hasta = '20211206' )
 ...
 DELETE FROM zrent_cars_ap.
 INSERT zrent_cars_ap FROM TABLE @lt_cars.
 SELECT * FROM zrent_cars_ap INTO TABLE @lt_cars.
 out->write( sy-dbcnt ).
...
DELETE FROM zrent_custome_ap.
 INSERT zrent_custome_ap FROM TABLE @lt_customers.
 SELECT * FROM zrent_custome_ap INTO TABLE
@lt_customers.
 out->write( sy-dbcnt ).
